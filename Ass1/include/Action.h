...
class Simulation;//forward declaretion
...
class BaseAction{
    public:
        ...
        //Added
        const std::string ActionStatusToString(ActionStatus stat) const;

    protected:
        void complete(); // Will change the status to "COMPLETED"
        void error(string errorMsg); // Will change the status to "ERROR" and updates error
